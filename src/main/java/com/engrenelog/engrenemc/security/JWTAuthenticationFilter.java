...
import com.engrenelog.engrenemc.dto.CredentialesDTO;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res) throws AuthenticationException{
		try{
				CredentialesDTO creds = new ObjectMapper()
				.readValue(req.getInputStream(),CredentialesDTO.class);
			                             ...
			                             Authentication auth) throws IOException, ServletException
   {
	...
	private class JWTAuthenticationFailureHandler implements AuthenticationFailureHandler{	
		...
		@Override
		public void onAuthenticationFailure(HttpServletRequest request,HttpServletResponse response, AuthenticationException except)
